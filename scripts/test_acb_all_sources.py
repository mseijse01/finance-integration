#!/usr/bin/env python3
"""
Test script to verify our multi-layer data source approach works for ACB.
...
from models.db_models import SessionLocal, FinancialReport, Earnings
from sqlalchemy import desc


def test_acb_data_sources():
    """Test the complete multi-layer data source strategy for ACB."""
    print("\n=== Testing Multi-Source Strategy for ACB ===\n")

    # Step 1: Test hardcoded data first to ensure it works
    print("1. Hardcoded Data Source:")
    print("\n   Hardcoded Financials:")
    hardcoded_financials = get_hardcoded_financials("ACB", "quarterly")
    ...
    print("\n   Hardcoded Earnings:")
    hardcoded_earnings = get_hardcoded_earnings("ACB")
    ...
    print("\n   Financials Service:")
    financials = fetch_financials("ACB", freq="quarterly")
    ...
    if financials and financials.get("data"):
        ...
        elif financials.get("source") == "Aurora Cannabis Investor Relations":
